...
class CookbooksControllerTest < ActionController::TestCase
  ...
  test "should create cookbook" do
    assert_difference('Cookbook.count') do
      post :create, cookbook: { avatar: @cookbook.avatar, category: @cookbook.category, chef: @cookbook.chef, description: @cookbook.description, ingredients: @cookbook.ingredients, title: @cookbook.title }
    end
  ...
  test "should update cookbook" do
    patch :update, id: @cookbook, cookbook: { avatar: @cookbook.avatar, category: @cookbook.category, chef: @cookbook.chef, description: @cookbook.description, ingredients: @cookbook.ingredients, title: @cookbook.title }
    assert_redirected_to cookbook_path(assigns(:cookbook))
  end
